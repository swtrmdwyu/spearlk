...
export default function SearchIcon({ fill = "#000000", size = "1rem" }: SearchIconProps) {
    return(
        <>
            ...
            <g>
                <path fill={fill} d="M495.152,413.801l-52.688-52.688c22.688-37.688,34.344-80.266,34.313-122.734
